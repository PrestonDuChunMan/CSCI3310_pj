...
public class Properties {
    ...
    public Properties(String id, String address, String name, String nSearch1, String nSearch2, String nSearch3, String nSearch4, String nSearch5, String nSearch6) {
        this.OBJECTID = id;
    ...
    public static Properties fromIntent(Intent intent) {
        ...
        return new Properties(id, address, name, nSearches[0], nSearches[1], nSearches[2], nSearches[3], nSearches[4], nSearches[5]);
    }
}
